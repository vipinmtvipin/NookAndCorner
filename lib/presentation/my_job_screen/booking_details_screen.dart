                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          ResponsiveText(
                              text:
                                  selectedJob.servicePrice?.service?.name ?? '',
                                ...
                                children: [
                                  ...
                                  ListView.builder(
                                      ...
                                      itemBuilder:
                                        ...
                                        final addon = selectedJob.orders[index];
                          ...
                          Obx(
                            () => Visibility(
                              visible: controller.addOns.value.isNotNullOrEmpty,
                              child: Card(
                                elevation: 6,
                                color: AppColors.white,
                                child: Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Flexible(
            child: ResponsiveText(
              maxLines: 1,
              text: "Rs ${addon.addonPrice.toString() ?? '0.0'} /-",
              style: AppTextStyle.txt12,
              textAlign: TextAlign.center,
            ),
          ),
