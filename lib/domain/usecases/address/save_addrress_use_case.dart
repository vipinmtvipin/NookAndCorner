...
class SaveAddressUseCase extends ParamUseCase<CommonResponds?, AddressRequest> {
  final AddressRepository _repo;
  SaveAddressUseCase(this._repo);

  @override
  Future<CommonResponds?> execute(AddressRequest params) {
    return _repo.saveAddress(params);
  }
}
